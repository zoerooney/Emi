 ...
 * handled by a callback to this_is_a_test_comment() which is
...
?>
	...
	<?php if ( post_password_required() ) : ?>
		<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'this-is-a-test' ); ?></p>
	</div><!-- #comments -->
	<?php
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * See this_is_a_test_comment() in inc/functions/comments.php for more.
				 */
				wp_list_comments( array( 'callback' => 'this_is_a_test_comment' ) );
			?>
		</ol>

		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // are there comments to navigate through ?>
		<nav id="comment-nav-below">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'this-is-a-test' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'this-is-a-test' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'this-is-a-test' ) ); ?></div>
		</nav>
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'this-is-a-test' ); ?></p>
	<?php endif; ?>
