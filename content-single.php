...
<div class="comments-link"><?php comments_popup_link( '<span class="leave-reply">' . __( 'No comments', 'emitheme' ) . '</span>', __( '<b>1</b> comment', 'emitheme' ), __( '<b>%</b> comments', 'emitheme' ) ); ?></div>
